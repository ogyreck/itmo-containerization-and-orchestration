...
### Создания вриатуальных машин

Создадал для работы кластера 4 вируталки,  и еще одну для тестов(sandbox). В качестве ОС выбрал Debian 12( уже был на проксмоксе ). Для простоты, был заготовлен шаблон вм с дебной и также уже все нужное настроено для cloude-init запуска вм. Очень удобная штука, прям в интерфейсе накликиваешь айпишники, характеристики и вм готова, почти тоже самое что у какого то облака, но бесплатно и свое. 
